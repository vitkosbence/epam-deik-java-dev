...
public class MovieCommand {
    ...
    @ShellMethod(key = "update movie",
            value = "Updates am existing movie from: title, genre, and length arguments by title")
    ...
    public String movieList() {
        ...
        for (MovieDto movie :
                movies) {
            stringBuilder.append(separator + movie.getTitle()
                    + " (" + movie.getGenre() + ", " + movie.getLength() + " minutes)");
            separator = "\n";
        }
